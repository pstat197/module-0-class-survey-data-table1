...
ggplot(bg_cs16, aes(x = as.factor(CS16), fill = as.factor(prog.comf))) +
  ...
  labs(title = "Programming Comfort by CS16 Participation", x = "Took CS16", y = "Count", fill = "Programming Comfort") +
  theme_minimal()
...
ggplot(bg_cs9, aes(x = as.factor(CS9), fill = as.factor(prog.comf))) +
  geom_bar(position = "dodge") +
  labs(title = "Programming Comfort by CS9 Participation", x = "Took CS9", y = "Count", fill = "Programming Comfort") +
  theme_minimal()